    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
            ...
            <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Laporan Data Transaksi</h1>
				    </div>
			    </div><!--//row-->

                <div class="row mb-3">
                    <div class="col inline">
                        <form action="laporanku.php" class="form-inline ml-2" method="get">
                            ...
                            if(isset($_GET['filter'])) // Jika user mengisi filter tanggal, maka munculkan tombol untuk reset filter
                                echo '<a href="laporanku.php" class="btn btn-primary ml-2">RESET</a>';
                            ?>
			        ...
			        <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
					    <div class="app-card app-card-orders-table shadow-sm mb-5">
                            ...
                            <tbody>
                                ...
                                if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
                                    while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                                        $total_sementara = $data['quantity'] * $data['harga_barang'];
                                        $tot_bayar += $total_sementara;
                                        // Format rupiah untuk harga_barang
                                        $harga_barang_formatted = "Rp " . number_format($data['harga_barang'], 0, ',', '.');

                                        // Format rupiah untuk subtotal
                                        $subtotal_formatted = "Rp " . number_format($data['subtotal'], 0, ',', '.');
                            ...
                            <tr>
                                ...
                                <th><b>Rp. <?php echo number_format($tot_bayar, 0, ',', '.'); ?>,-</b></th>
                            </tr>
                            </tfoot>
                            </table> 
