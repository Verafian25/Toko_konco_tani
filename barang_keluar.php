						    ...
						    <div class="app-card-body">
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
                                        <?php
                                        $ambildatanya = mysqli_query($conn, "SELECT * FROM barang_keluar");
                                        ...
                                        ?>
											<tr>
                                                ...
                                                <td class="cell">
                                                    ...
                                                    <a href="proses.php?hapus-keluar=<?= $id_keluar; ?>" onclick="return confirm(`yakin menghapus?`)" class="btn btn-danger">Delete</a>
                                                </td>
                                            <tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="proses.php" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary" name="tambah-keluar">Save</button>
                    </div>
                </form>
            </div>
        </div>
